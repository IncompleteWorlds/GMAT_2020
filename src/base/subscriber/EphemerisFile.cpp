   ...
   includeEventBoundaries  (true)
{
   ...
   // ajfg
   fileFormatList.push_back("JSON");
   fileFormatList.push_back("CSV");
...
void EphemerisFile::CreateEphemerisWriter()
{
   ...
   {
      ephemWriter = new EphemWriterJSON(GetName(), fileFormat);
      ((EphemWriterJSON*)ephemWriter)->SetDistanceUnit(distanceUnit);
      ((EphemWriterJSON*)ephemWriter)->SetIncludeEventBoundaries(includeEventBoundaries);
   }
   // TODO
   // else if (fileFormat == "CSV")
   // {
