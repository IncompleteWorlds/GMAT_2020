...
public:
   ...
   static std::string   FormatGregorian(YearNumber year, MonthOfYear month,
    ...
    // ajfg
    static bool          IsValidJulian(const std::string &str, bool checkDate);
   ...
   static bool          IsValidGregorianExtra(const std::string &str, bool checkDate = false, Integer format = 1);

   // ajfg
   static bool          ConvertGregorianFormat(const std::string &inStr, const Integer inFormat, 
