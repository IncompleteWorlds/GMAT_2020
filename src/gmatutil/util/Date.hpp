...
protected:
    ...
    Date(const std::string& time, Integer format);
    ...
    bool ParseFormat1(const std::string& time);
    bool ParseFormat2(const std::string& time);
    bool ParseFormat3(const std::string& time);
